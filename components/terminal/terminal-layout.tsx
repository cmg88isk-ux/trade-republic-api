...
const navItems: NavItem[] = [
  ...
  { href: '/markets', label: 'Markets', icon: <BarChart3 className="h-4 w-4" /> },
  { href: '/arbitrage', label: 'Arbitrage', icon: <ArrowLeftRight className="h-4 w-4" /> },
  { href: '/signals', label: 'Signals', icon: <Bell className="h-4 w-4" /> },
      ...
      <div className="p-4 border-b border-sidebar-border">
        <Link href="/dashboard" className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
            <span className="font-semibold text-sm text-sidebar-foreground">GoldArb</span>
...
export function TerminalLayout({ children, title, actions }: TerminalLayoutProps) {
  const pathname = usePathname();
