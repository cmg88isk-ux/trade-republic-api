  ...
  for (let i = 0; i < count; i++) {
    ...
    signals.push({
      ...
      rationale: signalType === 'BUY' 
        ? 'TR price significantly below Binance reference'
        : signalType === 'SELL'
        ? 'TR price above Binance reference with high z-score'
        : 'Spread near threshold, monitoring',
...
export default function HistoryPage() {
  ...
  const exportToCSV = () => {
    const headers = ['Date', 'Time', 'Asset', 'Instrument', 'Signal', 'Spread %', 'Z-Score', 'Status', 'Rationale'];
